...
//
				...
				+ "  end \n"
				+ "  log('    returned ' .. #patternMembers .. ' triples') \n"
				+ "  for i,pattern in ipairs(patternMembers) do \n"
				+ "    table.insert(patternResult, cjson.decode(pattern)) \n"
//				+ "    table.insert(patternResult, row) \n"
//				+ "    local triple = cjson.decode(pattern) \n"
//				+ "    local row = {} \n"
...
//				+ "  log('headers after join: ' .. cjson.encode(thisMapResult[1])) \n"
//				+ "  for i=2,(#thisMapResult-1) do \n"
//				+ "    for j=(i+1),#thisMapResult do \n"
//				+ "      if thisMapResult[i] == thisMapResult[j] then \n"
//				+ "        log('rows ' .. i .. ' and ' .. j .. ' match: ' .. cjson.encode(thisMapResult[i])) \n"
//				+ "      end \n"
//				+ "    end \n"
//				+ "  end \n"
