...
public class Project implements RedisOP {
	...
	public Project(){
		...
		projectScript = ""
				...
				+ "local logKey = KEYS[3] \n"
				+ "\n"
				+ "local result = cjson.decode(redis.call('get', graphPatternKey)) \n"
				...
				+ "redis.call('rpush', logKey, 'projected vars is ' .. cjson.encode(projectedVarNames)) \n "
				...
				+ "        redis.call('rpush', logKey, 'projecting variable ' .. projectedVarName .. ' at position ' .. j) \n"
